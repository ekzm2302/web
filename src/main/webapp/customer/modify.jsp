	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				...
				<input type='hidden' name='id' value='${dto.id }'>
					<table class='w-px400'>
						...
						<tr>
							<th>성별</th>
							<td><input type='radio'
								${ dto.gender eq'남' ? 'checked' : '' } name='gender' value='남'>
								남 <input type='radio' ${ dto.gender eq'여' ? 'checked' : '' }
				...
				<button class='btn btn-secondary' onclick='location="info.cu?id=${dto.id}"'>취소</button>
				</div>
